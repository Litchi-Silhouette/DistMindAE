...
python build/bin/controller.py settings/controller.json False > tmp/distmind/log_controller.txt 2>&1 &
PID_CONTROLLER=$!
...
./scripts/run_client_max_inference.sh > tmp/distmind/log_client.txt
