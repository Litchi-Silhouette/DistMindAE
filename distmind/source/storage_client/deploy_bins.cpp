...
int main(int argc, char const* argv[]) {
  ...
  std::vector<std::pair<std::string, std::string>> ip_ports;
  ip_ports.push_back(std::make_pair("172.31.2.54", "7778"));
  ip_ports.push_back(std::make_pair("172.31.12.207", "7778"));
  ip_ports.push_back(std::make_pair("172.31.1.148", "7778"));
  ip_ports.push_back(std::make_pair("172.31.13.249", "7778"));

  std::string model_folder("/home/ubuntu/pipeps/build/resource/resnet152");
