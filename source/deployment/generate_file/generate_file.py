...
def import_model(model_name):
    seed = model_name.split('-')[0]
    print (model_name, seed)
    if seed in cached_model:
        return cached_model[seed]
    ...
    func_list, batch_list = module.import_model_reimpl_with_batching(train=('train' in model_name))
    ...
    cached_model[seed] = (shape, func_info, param_list, batch_list, model_size)
...
def main():
    ...
    for model_name in model_list:
        shape, func_info, param_list, batch_list, model_size = import_model(model_name)
